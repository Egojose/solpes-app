...
export class SPServicio {
    ...
    public ObtenerConfiguracionConPost() {
        const configuracionSharepoint = pnp.sp.configure({
            headers: {
                ...
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6Ik4tbEMwbi05REFMcXdodUhZbkhRNjNHZUNYYyIsImtpZCI6Ik4tbEMwbi05REFMcXdodUhZbkhRNjNHZUNYYyJ9..TYb2V6Wjxd_ApZ-6lUZuLD73dDTYUzkFSowQaTTVBI57gcfT1miWbObDsFOYFax1z7TDFTlnsUFtfPkZ54g815cF37G-gWHUp6zrnYQ2tGugQRG8-26R0exHeIbiTzk0Ty8OuFvguniy0yg7H6GbOu9hyob5RJrL2o5TRvL9vlBjvWh0ktofay584WSt1t0vlLlS_Wykolks05jtVo6uVOlyaAK_2fjP_AexNQgGTia7f-kX_YPr8Xo7xg9B6J4O8cEApgeBhTfN9XKy3EDSEiuNt4pmff31h7DSuIjNz34KpfWYNMcgtOiJIBL-7QgqaqY47WzE6Vuw14kVmq54sg'
            }
        }, environment.urlWeb);
    ...
    ObtenerReporteContratos(fechaInico, fechaFin){
        let respuesta = from(this.ObtenerConfiguracion().web.lists.getByTitle(environment.listaContratos).items.select("*","Solicitud/Consecutivo").filter("Created ge datetime'"+fechaInico+"T00:00:00.00Z' and Created le datetime'"+fechaFin+"T23:59:59.00Z'").expand("Solicitud").get());
        return respuesta;
    }

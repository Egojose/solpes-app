...
export class SPServicio {
    ...
    public ObtenerConfiguracionConPost() {
        const configuracionSharepoint = pnp.sp.configure({
            headers: {
                ...
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6ImtnMkxZczJUMENUaklmajRydDZKSXluZW4zOCIsImtpZCI6ImtnMkxZczJUMENUaklmajRydDZKSXluZW4zOCJ9..Oz9LxpHIK10eUV73l3psKpLrH2yRKquMLVjDhtGEsu9XAlXax7cdGx1j5XPAm9CM8cGfode05WEx0EKUFM0vUr9SfvvI0X2ti2BLO-YN1ejCO-7-Z0aeZ1oQnHI5ItJDgcerWwL5jmdZ-MsJh9epIbImtcsJGQK08F-mWzypfJA44Iuuba6Qa6IpKCvINN-8lAJrBF6IfbR-ZRccOkSFyi6UDdLbyiLkwvkOAp-eaxubyG4zyPsbKlybu6nCPTLXSDm7hGitHkAL3IbfFPZpD5WbReWSHlQ6jn7n7yC8JX3QOWwm6QDcPLJJyFQtjRHiF79CJ5Yks6T0SHx145JCMg'
            }
        }, environment.urlWeb);
    ...
    //     return this.ObtenerConfiguracion().web.lists.getByTitle(environment.listaSolicitudes).items.getById(idSolicitud).update(solicitud);
    // }
    ...
    actualizarSolicitud(idSolicitud: number, solicitud: Solicitud){
        return this.ObtenerConfiguracion().web.lists.getByTitle(environment.listaSolicitudes).items.getById(idSolicitud).update({
            ...
            TipoSolicitud: solicitud.tipoSolicitud,
            CM: solicitud.cm,
            NumeroContrato: solicitud.nroContrato,
            Solicitante: solicitud.solicitante,
            EmpresaId: solicitud.empresa,
            OrdenadorGastosId: solicitud.ordenadorGastos,
            PaisId: solicitud.pais,

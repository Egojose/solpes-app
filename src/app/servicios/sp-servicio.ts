...
export class SPServicio {
    ...
    public ObtenerConfiguracionConPost() {
        const configuracionSharepoint = pnp.sp.configure({
            headers: {
                ...
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6Ii1zeE1KTUxDSURXTVRQdlp5SjZ0eC1DRHh3MCIsImtpZCI6Ii1zeE1KTUxDSURXTVRQdlp5SjZ0eC1DRHh3MCJ9..Jo9DF0yj1oBSYnD-7MWzyVDhzHEh5l32gxzhM4ugMTBlVSbgbsmEtNYaR6ExEZluUS3RqRzICtS5sELNRHGg_UInXOFcoUKPHDaDCE6M4G4mDylB0z4p_YRuHH9Dd-NLvLynXEe5mhtKhHuo2LYUcDEl2YiHngSEVG9SOo2ebB-WUSx-XfYKaDZ7tMH0isCH6VhVa1zF79E39dyufye-ZX7MWDQGXf0eiy5eOtd3RzRvGkHjzcd_AhqSJnSIwnl04l2TJX1owFdCXU8ortcf1IcEd2yGGHmsXIKkBIt2RrG57eYlQDaBPOuPXgtuo5FILGXF2UzVXlU9glqkx1G3ng'
            }
        }, environment.urlWeb);
    ...
    ObtenerRecepcionesServicioEntregaServicio(IdSolicitud){
        let respuesta = from(this.ObtenerConfiguracion().web.lists.getByTitle(environment.listaRecepcionServicios).items.filter("IdSolicitud eq '"+IdSolicitud+"' and recibidoSap eq '0'").select("*","AttachmentFiles").expand("AttachmentFiles").get());
        return respuesta;
    }
